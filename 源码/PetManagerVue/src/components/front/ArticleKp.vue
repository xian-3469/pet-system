<template>
  <div  style="margin: 10px 0">
    ...
    <div class="articleKp"><i class="el-icon-magic-stick"></i> 宠物科普</div>
    ...
    <div style="margin: 10px 0;">
      <div v-for="item in tableData" style="padding: 20px; border-radius: 10px; background-color: #fff; margin: 10px 0" :key="item.id">
        <div style="display: flex">
          ...
          <div style="flex: 1">
            <div style="font-size: 20px; font-weight: bold; color: #ff7d00; cursor: pointer" @click="view(item.id, item.content)">{{ item.name }}</div>
          ...
          <div style="width: 200px; text-align: center">
            <el-image :src="$store.state.baseApi+item.img" style="width: 100px" :preview-src-list="[$store.state.baseApi + item.img]"></el-image>
          </div>
